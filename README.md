...
See: https://github.com/marcelveldt/script.skin.helper.colorpicker

For backwards compatability the colorpicker method can still be called on this main addon.
